...
// Test 6: Inflammation-Led Female (thyroid + scalp symptoms)
test("Inflammation-Led Female, Mid Stage", {
  Q01_SEX: "F",
  Q02_AGE: 38,
  Q03_VISIBLE_LOSS_F: "LW2",
  Q04_ONSET_YEARS: "1-3y",
  Q05_PROGRESSION_RATE: "fast",
  Q06_FH_PATERNAL: "mild",
  Q07_FH_MATERNAL: "mild",
  Q08_SCALP_VISIBLE: "finer",
  Q09_LOSS_PATTERN: "part_line",
  Q10_ANDROGEN_SIGNS: "none",
  Q11_HORMONAL_F: "none",
  Q12_SLEEP: "ok",
  Q13_STRESS: "elevated",
  ...
  Q16_SCALP_VISUAL: "redness",
  Q17_WASH_HABITS: "good",
  Q18_AUTOIMMUNE: "thyroid",
  Q19_RECENT_HEALTH: "none",
  Q20_PERIPHERAL_TEMP: "sometimes",
  Q21_MOVEMENT: "light",
  Q22_DIET_QUALITY: "mostly_good",
  Q23_FIBROSIS_DIRECT: "normal",
  Q24_GROWTH_SIGNALLING_DIRECT: "slower",
  Q25_PHARMA_OPENNESS: "natural_first",
  Q26_EMAIL: "test@example.com",
});

// Test 7: Vascular-Compromised Male (cold extremities + sedentary + smoker)
test("Vascular-Compromised Male, Early Stage", {
  Q01_SEX: "M",
  Q02_AGE: 30,
  Q03_VISIBLE_LOSS_M: "NW2",
  Q04_ONSET_YEARS: "1-3y",
  Q05_PROGRESSION_RATE: "slow",
  Q06_FH_PATERNAL: "mild",
  Q07_FH_MATERNAL: "none",
  Q08_SCALP_VISIBLE: "finer",
  Q09_LOSS_PATTERN: "temples_crown",
  Q10_ANDROGEN_SIGNS: "teen_acne",
  Q11_HORMONAL_M: "none",
  Q12_SLEEP: "ok",
  Q13_STRESS: "elevated",
  Q14_SMOKING: "occasional",
  Q15_SCALP_FEEL: "normal",
  Q16_SCALP_VISUAL: "normal",
  Q17_WASH_HABITS: "good",
  Q18_AUTOIMMUNE: "none",
...
// Test 8: Nutritionally-Depleted Female (restrictive diet + weight loss)
test("Nutritionally-Depleted Female, Early Stage", {
  Q01_SEX: "F",
  Q02_AGE: 25,
  Q03_VISIBLE_LOSS_F: "LW1",
  Q04_ONSET_YEARS: "<1y",
  Q05_PROGRESSION_RATE: "fast",
  Q06_FH_PATERNAL: "none",
  Q07_FH_MATERNAL: "none",
  ...
  Q17_WASH_HABITS: "good",
  Q18_AUTOIMMUNE: "none",
  Q19_RECENT_HEALTH: "weight_loss",
  Q20_PERIPHERAL_TEMP: "often",
  Q21_MOVEMENT: "intense",
  Q22_DIET_QUALITY: "restrictive",
  Q23_FIBROSIS_DIRECT: "no_thinning",
  Q24_GROWTH_SIGNALLING_DIRECT: "normal",
  Q25_PHARMA_OPENNESS: "natural_only",
  Q26_EMAIL: "test@example.com",
...
// Test 9: Oxidative-Stressed Male (endurance athlete + shift work)
test("Oxidative-Stressed Male, Early Stage", {
  Q01_SEX: "M",
  Q02_AGE: 33,
  Q03_VISIBLE_LOSS_M: "NW2",
  Q04_ONSET_YEARS: "1-3y",
...
// Test 10: Scalp-Disrupted Male (dandruff + bad wash habits)
test("Scalp-Disrupted Male, Mid Stage", {
  Q01_SEX: "M",
  Q02_AGE: 40,
  Q03_VISIBLE_LOSS_M: "NW34",
  Q04_ONSET_YEARS: "3-7y",
  ...
  Q14_SMOKING: "never",
  Q15_SCALP_FEEL: "dry",
  Q16_SCALP_VISUAL: "greasy",
  Q17_WASH_HABITS: "infrequent",
  Q18_AUTOIMMUNE: "allergies",
  Q19_RECENT_HEALTH: "none",
  Q20_PERIPHERAL_TEMP: "normal",
  Q21_MOVEMENT: "moderate",
  Q22_DIET_QUALITY: "mixed",
  Q23_FIBROSIS_DIRECT: "smooth",
  Q24_GROWTH_SIGNALLING_DIRECT: "normal",
  Q25_PHARMA_OPENNESS: "hybrid",
  Q26_EMAIL: "test@example.com",
...
// Test 11: Androgen-Dominant with Inflammatory Overlay Male
test("Androgen-Dominant with Inflammatory Overlay Male, Late Stage", {
  Q01_SEX: "M",
  Q02_AGE: 45,
  Q03_VISIBLE_LOSS_M: "NW67",
  Q04_ONSET_YEARS: ">7y",
  Q05_PROGRESSION_RATE: "slow",
  Q06_FH_PATERNAL: "all",
  Q07_FH_MATERNAL: "most",
  ...
  Q23_FIBROSIS_DIRECT: "shiny",
  Q24_GROWTH_SIGNALLING_DIRECT: "slower",
  Q25_PHARMA_OPENNESS: "existing_pharma",
  Q26_EMAIL: "test@example.com",
});
